(() => {
  ...
  class ContadorComponent {
    ...
    prepararBotaoReinciar(elementoBotao, iniciarFn) {
    ...
    inicializar() {
      ...
      {
        const elementoBotaoReinciar = document.getElementById(BTN_REINICIAR);
        const desabilitarBotao = this.prepararBotaoReinciar(elementoBotaoReinciar, this.inicializar);
